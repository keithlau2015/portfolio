        ...
        <div class="container my-24 mx-auto md:px-6">
          ...
          <ol class="relative ml-20 border-l border-gray-200 dark:border-gray-700">                  
            <li class="mb-10 ml-10">            
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-white">Karin Group<span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded ml-3">Latest</span></h3>
