...
export function ProjectCard({title, description, bg, owner, type, subType, duty, tech}) {
    return (<div class={`
        ...
        ${bg}
    `}>
        <ProjectDetailsPopover owner={owner} type={type} subType={subType} duty={duty} tech={tech} />
