...
export function ProjectSection() {
    const projects = [
        {type:["Game"], subType:["PC"], owner:"Personal", title:"Dungeon Challenger", description:"Undergrad Final Year Project", bg:"url('https://keithlau2015.github.io/portfolio/project/dc.png')", duty:"My final year project. A singleplayer first person perspetive with random generated map game, player needed to handle monster, hunger and sanity to survive much level they can."},
        {type:["Game"], subType:["Moblie"],  owner:"Personal", title:"Space Shooter", description:"Moblie game", bg:"url('https://keithlau2015.github.io/portfolio/project/spaceshooter.png')", duty:"My first moblie game, also a challenge for myself finished the game within 1 week. A singleplay 3rd person shooter game, player needed to control the spacecraft to fight obstacle, also player able to get reward through watching ads, and unlock more different playstle spacecraft."},
        {type:["Game", "Server"], subType:["Moblie"], owner:"Gameone Group Limited", title:"正版龍虎門", description:"Moblie game", bg:"url('https://keithlau2015.github.io/portfolio/project/dtg1.png')"},
        {type:["Game", "Server"], subType:["Moblie"], owner:"Gameone Group Limited", title:"新火鳳燎原亂世英雄", description:"Undergrad Final Year Project", bg:"url('https://keithlau2015.github.io/portfolio/project/fire.png')"},
        {type:["Game", "Server"], subType:["Moblie"], owner:"Gameone Group Limited", title:"龍虎門M", description:"Undergrad Final Year Project", bg:"url('https://keithlau2015.github.io/portfolio/project/dtg2.png')"},
        {type:["Game"], subType:["AR"], owner:"CIMPTech", title:"Mannings 50th Anniversary Event", description:"AR Game", bg:"url('https://keithlau2015.github.io/portfolio/project/manningsEvent.png')"},
        ...
        {type:["Application", "Website"], owner:"Karin Group", title:"Department of Health TACO Information System", description:"Webapp", bg:"url('https://keithlau2015.github.io/portfolio/project/DH_logo.png')"},
        {type:["Application", "Website"], owner:"Karin Group", title:"Leisure and Cultural Services Department Electronic Collection Recording System", description:"Webapp", bg:"url('https://keithlau2015.github.io/portfolio/project/LCSD.png')"},
