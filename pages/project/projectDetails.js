...
export function ProjectDetailsPopover({owner, type, subType, duty}){
    return <span className="absolute min-w-[200px] lg:left-full md:left-full scale-0 transition-all rounded bg-gray-800 p-2 text-xs text-white group-hover:scale-100">
      <div className="text-base font-bold">Project Owner:</div>
      <div className="text-sm text-slate-300">{owner}</div>
      <div className="my-1 container overflow-hidden bg-fixed bg-slate-900">
